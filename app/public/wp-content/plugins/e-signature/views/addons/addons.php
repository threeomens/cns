            ...
            if ($addonlist == "esig-price") {
                ...
                if (($esig_license_type = $this->setting->get_generic('esig_wp_esignature_license_type') ) != 'Business License') {
                    ...
                    if (Esign_licenses::get_license_type() == 'Professional License' && $license_key != 'no') {
                        ...
                        $price = $professional_price;  //$buisness_price;
                    }
                    ...
                    if (Esign_licenses::get_license_type() != 'business-license'):
                        ...
                        <div class="esig-add-on-block esig-pro-pack open">
					        ...
					        <a href="#" class="esig-dismiss">No thanks</a>', $price, 'esig'), $price); ?>
                ...
                <div class="esig-add-on-block">
                    ...
                    <div class="esig-add-on-info">
                        ...
                        <span class="esig-add-on-author"> <?php _e('by', 'esig'); ?> <a href="https://www.approveme.com/wp-e-signature" target="_blank"><?php _e('Approveme', 'esig'); ?></a></span>
            ...
            if ($addonlist == "esig-price") {
                  ...
                  /*  $buisness_price = is_array($addons) ? $addons[0]->amount : null;
                    ...
                    <div class="esig-add-on-block esig-pro-pack open">
                        <?php echo sprintf(__('<h3>Get the E-Signature Buisness Pack</h3>
					        ...
					        <a class="esig-btn-pro" href="http://www.approveme.com/wp-e-signature/?add-ons-plugin" target="_blank">Get all our add-ons</a> ', 'esig')); ?>
                    ...
                    <div class="esig-add-on-block esig-pro-pack open">
                        <?php _e('<h3>Are there any features you\'d like to see?</h3>
					        ...
					        <a class="esig-btn-pro" href="http://approveme.uservoice.com/" target="_blank">Submit a feature request</a> ', 'esig'); ?>
                ...
                if ($plugin_file) {
...
</div><div class="esig-add-on-buy-now"><a href="https://www.approveme.com/wp-digital-e-signature#pricingPlans" target="_blank" class="eisg-addons-upgrade">' . __('Upgrade Now', 'esig') . '</a></div></div>';
                    }
                    ...
                    <div class="esig-add-on-block">
                        ...
                        <div class="esig-add-on-info">
                            <h4><a href="<?php echo $addons->download_page_link; ?>" target="_blank"><?php echo "WP E-Signature - " . $addons->addon_name; ?></a></h4>
                            <span class="esig-add-on-author"> <?php _e('by', 'esig'); ?> <a href="https://www.approveme.com/"><?php _e('ApproveMe.com', 'esig'); ?></a></span>
