...
(function ($)
{
    ...
    $(function ()
    {
        ...
        $('body').on('click', '.esig-sif-panel-file .insert-file', function () {
            ...
            var return_text = '[esigfile name="' + name + '" label="' + file_label + '"  verifysigner="' + verifysigner_file + '" filesize="' + file_size + '"   ' + required + ']';
        ...
        $("body").on("click", ".esig-sif-panel-radio ul li #addRadio", function ()
        {
            $("#radio_html").append("<li id=\"removeradio\">" +
                    ...
                    "<span><input type=\"text\" class=\"deletablesif\" name=\"label[]\" placeholder=\"Label\" value=\"\" /></span>" +
        ...
        $("body").on("click", ".esig-sif-panel-dropdown ul li #addDropdown", function ()
        {
            $("#dropdown_html-rupom").append("<li id=\"removedropdown\">" +
                    "<span><input type=\"text\" name=\"label[]\" placeholder=\"Label\" value=\"\" /></span>" +
