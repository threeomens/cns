...
function bones_scripts_and_styles() {
  ...
  if (!is_admin()) {
    ...
    // custom style sheet
    wp_register_style( 'custom-style', get_template_directory_uri() . '/library/css/custom.css', array(), '' );
    ...
    wp_register_script( 'addthis-js','https://s7.addthis.com/js/250/addthis_widget.js', array( 'jquery' ), '1.0', true );

    //adding scripts file in the footer
    wp_register_script( 'bones-js', get_template_directory_uri() . '/library/js/scripts.js', array( 'jquery' ), '', true );

    //custom js file
    wp_register_script( 'custom-js', get_template_directory_uri() . '/library/js/custom.js', array( 'jquery' ), '2.0', true );
